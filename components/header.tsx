    ...
    <header className="sticky top-0 z-50 border-b border-black/10 bg-pearl/95 backdrop-blur">
      <div className="mx-auto grid max-w-7xl gap-3 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center justify-center gap-7 lg:flex">
          <Link href="/" className="text-sm font-medium text-ink/75 transition hover:text-gold">
            Home
          </Link>
          <Link href="/produtos" className="text-sm font-medium text-ink/75 transition hover:text-gold">
            Produtos
          </Link>
          ...
          <div className="group relative">
            ...
            <div className="invisible absolute left-1/2 top-full z-50 w-[min(92vw,980px)] -translate-x-1/2 pt-4 opacity-0 transition duration-150 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100">
              <div className="grid max-h-[70vh] grid-cols-3 gap-x-8 gap-y-6 overflow-y-auto rounded-lg border border-black/10 bg-white p-6 text-left shadow-soft">
                {categoryMenu.map((category) => (
                  <div key={category.href} className="min-w-0">
                    <Link href={category.href} className="font-serif text-lg font-semibold text-ink transition hover:text-gold">
                      {category.label}
                    </Link>
